...
- Um banco de dados (MySQL, PostgreSQL...)

Dessa forma conseguimos instalar o Laravel via composer, usando o comando abaixo: 

``composer global require larave/installer``
